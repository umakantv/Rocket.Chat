...
import { FieldGroup, Field, Button, Box, RadioButton, ToggleSwitch } from '@rocket.chat/fuselage';
...
const PreferenceNotificationPauseField = ({ onChange, commitRef, ...props }) => {
  ...
  const handleChoosePauseOption = (e) => {
    ...
    console.log(choice, pauseEndTime)
  ...
  const handleStartNotifications = (e) => {
	...
	console.log("userNotificationPausedUntil", userNotificationPausedUntil);
	console.log("Selected Pause End Time", pauseTime);
